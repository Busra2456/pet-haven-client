...
const Dashboard = () => {
      ...
      return (
             <div className="flex mt-6">
                  {/* dashboard side bar */}
                  <div className="w-64  min-h-screen bg-zinc-200">
                        <ul className="menu mt-13">
                              {
                                    isAdmin ? <>
                                     <li>
                              ...
                              <li>
                                    ...
                                    <NavLink to="/dashboard/add-review/:dogId"> 
                                    <FaList></FaList>
...
{/* shared nav links */}
 ...
 Contact</NavLink></li>                                 
                  ...
                  {/* dashboard content */}
                  <div className="flex-1 p-5 bg-zinc-200">
                        <Outlet></Outlet>
                  </div>
            </div>
      );
